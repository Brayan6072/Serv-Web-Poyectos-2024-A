        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="VerReportes.jsp">Regresar</a></li>
            ...
            <div class="Consultar">
                ...
                <table border = "0">
                    ...
                    <tbody>
                        <%
                            List<Reporte> lista = AccionReporte.HistorialReporte();
                        ...
                        <tr>
                            ...
                            <td><div id="semaforo" class="luz" style="<% if(rpt.getEstatus().equals("verde")) { 
